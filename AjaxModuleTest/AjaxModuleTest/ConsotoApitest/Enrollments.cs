...
{
    internal partial class Enrollments : IServiceOperations<ConsotoApitest>, IEnrollments
    {
        /// <summary>
        ...
        /// </param>
        internal Enrollments(ConsotoApitest client)
        {
            this._client = client;
        }
        
        private ConsotoApitest _client;
        
        /// <summary>
        /// Gets a reference to the AjaxModuleTest.ConsotoApitest.
        /// </summary>
        public ConsotoApitest Client
        {
