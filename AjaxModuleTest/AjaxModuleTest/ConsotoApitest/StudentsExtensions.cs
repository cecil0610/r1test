...
namespace AjaxModuleTest
{
    public static partial class StudentsExtensions
    {
        ...
        /// Reference to the AjaxModuleTest.IStudents.
        /// </param>
        /// <param name='id'>
        /// Required.
        /// </param>
        ...
        {
            Microsoft.Rest.HttpOperationResponse<AjaxModuleTest.Models.Student> result = await operations.DeleteStudentWithOperationResponseAsync(id, cancellationToken).ConfigureAwait(false);
            return result.Body;
        }
        ...
        {
            Microsoft.Rest.HttpOperationResponse<AjaxModuleTest.Models.Student> result = await operations.GetStudentWithOperationResponseAsync(id, cancellationToken).ConfigureAwait(false);
            return result.Body;
        }
        ...
        {
            Microsoft.Rest.HttpOperationResponse<System.Collections.Generic.IList<AjaxModuleTest.Models.Student>> result = await operations.GetStudentsWithOperationResponseAsync(cancellationToken).ConfigureAwait(false);
            return result.Body;
        }
        ...
        {
            Microsoft.Rest.HttpOperationResponse<AjaxModuleTest.Models.Student> result = await operations.PostStudentWithOperationResponseAsync(student, cancellationToken).ConfigureAwait(false);
            return result.Body;
        }
